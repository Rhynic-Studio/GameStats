...
addCrash('2026-08-01', 'wsq', 'mzy', 'first', 0,
  ['艾娅', '苍玉露世', '菲尼斯涅维娜', '卫冕冠军 妮妮', '妮娜·安赫玛托娃', '伊诗·努·阿兰'],
  ['伊诗·努·阿兰', '苍玉露世', '艾娅', '菲尼斯涅维娜', '妮娜·安赫玛托娃', '卫冕冠军 妮妮'],
  [
    { idx: 1, initiative: 0, roleA: '伊诗·努·阿兰', roleB: '艾娅', result: 'a' },
    { idx: 2, initiative: 1, roleA: '妮娜·安赫玛托娃', roleB: '苍玉露世', result: 'a' },
  ],
  'log1');

// log3：bp模式，mzy 先手，打到一半
addCrash('2026-08-03', 'mzy', 'zhj', 'bp', 0,
  ['偶像N.A.G.I', '菲尼伽涅维娜', '怪盗x黑猫', '苍玉露世', '玄华妖姬', '芙芙', '卫冕冠军 妮妮', '商旅香诺尔', '艾娅', '骇客娜吉尼'],
  ['怪盗x黑猫', '骇客娜吉尼', '芙芙', '苍玉露世', '艾娅', '商旅香诺尔', '偶像N.A.G.I', '卫冕冠军 妮妮'],
  [{ idx: 1, initiative: 0, roleA: '卫冕冠军 妮妮', roleB: '芙芙', result: 'pending' }],
  'log3');
